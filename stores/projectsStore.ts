...
export const useProjectsStore = defineStore("projectsStore", () => {
  ...
  const projectsList = ref<IProject[]>([
    ...
    //   hash: "dif",
    //   link: "https://dartweider2000.github.io/resume-landing/dist/",
    //   image: "dif.png",
    //   stackList: getStackListByKeys([
    //     Stack.Html,
    //     Stack.Css,
    ...
    //   title: "Binance App",
    //   description:
    //     "В данном приложениии вы можете выбрать валютную пару и получить по ней биржевой стакан. Данные обновляются по WebSocket. Также на главной странице можно смотреть логи, когда вы меняли валютную пару",
    //   hash: "binance-app",
    ...
    //   description:
    //     "В данном приложениии вы можете снимать себя на веб-камеру. Можете делать это на ноутбуке или на телефоне. Несмотря на название, вы также можете делать и фотографии. После того как сделано фото, вы можете его обрезать до нужного размера. Фото и видео можно скачать.",
