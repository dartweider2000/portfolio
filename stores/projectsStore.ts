...
import funiro from "~/assets/img/funiro.webp";
import _32band from "~/assets/img/32band.webp";
import dif from "~/assets/img/dif.webp";
import involtaIQ from "~/assets/img/involta-iq.webp";
import relives from "~/assets/img/relives.webp";
import snake from "~/assets/img/snake.webp";
import tanks from "~/assets/img/tanks.webp";
import videoRecording from "~/assets/img/video-recording.webp";
import binanceApp from "~/assets/img/binance-app.webp";
import loginForm from "~/assets/img/login-form.webp";
...
export const useProjectsStore = defineStore("projectsStore", () => {
  ...
  const projectsList = ref<IProject[]>([
    ...
    },
    {
      title: "Login Form",
      description:
        "В данном приложении есть три формы: 1) форма логина (на фото), 2) форма регистрации, 3) форма для OTP",
      hash: "login-form",
      link: "https://dartweider2000.github.io/login-form/",
      image: loginForm,
      stackList: getStackListByKeys([
        Stack.Html,
        Stack.Css,
